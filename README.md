...
#### You can checkout the [**Demo Here**](https://MSAMedic.github.io/WhatATheme/) :boom:
...
> You can read **What is Jekyll** [**here**](https://MSAMedic.github.io/WhatATheme/blog/what-is-jekyll-how-to-use-it)
### Up and Running
* Fork the [Repository](https://github.com/MSAMedic/WhatATheme/)
* Clone or download the repository into directory of your choice: `git clone https://github.com/MSAMedic/WhatATheme.git`
* Inside the directory run `bundle install`
* Host WhatATheme locally by running `bundle exec jekyll s`

> You can read **How to Install and use WhatATheme?** [**here**](https://MSAMedic.github.io/WhatATheme/blog/how-to-install-whatatheme)
...
### License
The contents of this repository are licensed under the [**GNU General Public License v2.0**](https://github.com/MSAMedic/WhatATheme/blob/master/LICENSE)
